  ...
  return (
    <div className="h-[64px] w-full bg-gray-50 sticky top-0 z-[998] flex items-center justify-between px-4">
      <div className="flex items-center justify-center">
        ...
        {!isSearchOpen && (
          <h1 className="text-xl md:text-2xl pl-2 font-semibold">{title}
          </h1>
        )}
      </div>

      <div className="flex gap-2 items-center justify-center">
        <div className="relative mr-6 w-full md:w-64">
          {!isSearchOpen && (
            <Search
        ...
        <div className="flex items-center md:px-6 md:space-x-3 cursor-pointer shrink-0">
          <img
