    ...
    >
      ...
      >
        <div className="sticky top-0 z-10 flex items-center justify-between p-3 bg-yellow-500">
          ...
          <button
            onClick={closePopup}
            className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 text-base sm:text-lg text-white bg-red-500 rounded hover:bg-red-600"
          >
            ✕
          </button>
        </div>
        ...
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div>
              <label className="block mb-1 text-sm sm:text-base font-semibold text-gray-600">
                Flight Number:
              </label>
              <input
                type="text"
                ...
                className="w-full p-2 text-sm sm:text-base border rounded-xl"
                required
              />
            </div>
            <div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
            <div className="w-full sm:w-1/2">
              ...
              <div className="flex gap-4">
                <label className="flex items-center whitespace-nowrap text-sm sm:text-base">
                  <input
                    type="radio"
                    name="category"
                    value="Domestic"
                    className="mr-1 scale-125 sm:scale-150 cursor-pointer"
                    required
                  />{" "}
                  Domestic
                </label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <input
                type="text"
                name="departureTime"
                className="w-full p-2 text-sm sm:text-base border cursor-pointer rounded-xl mb-0"
                value={departureTime}
                readOnly
                onClick={(e) => {
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
            <div>
              ...
              <input
                type="date"
                name="selectedDate"
                className="w-full p-2 text-sm sm:text-base border cursor-pointer rounded-xl"
                required
                onFocus={(e) => e.target.showPicker()}
              />
            </div>
            <div>
              <label className="block mb-1 text-sm sm:text-base font-semibold">
                Rating:
              </label>
            ...
            {profilePicture && (
              <div className="mt-2">
                <img
                  src={profilePicture}
                  alt="Profile Preview"
                  className="object-cover w-20 h-20 sm:w-24 sm:h-24 border rounded-full"
                />
              </div>
            )}
          </div>
